...
\subsection{Site dos números primos}

TO-DO: Inserir as figuras da tela e da planilha, explicando o fluxo do site.

Neste exemplo, se considere um contribuidor do repositório FirstNPrimes. O qual é um projeto de um site que calcula os primeiros n números primos dentro do próprio navegador. Ou seja, todo o processamento é no lado do cliente.
