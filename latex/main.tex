...
\newacro{HTTP}{\emph{Hypertext Transfer Protocol}}
...
Neste capítulo estão descritos os tópicos relacionados a implementação da ferramenta, bem como da sua elaboração conceitual e da sua arquitetura interna. 

TO-DO: No final, descrever mais o que foi feito no formato de um roteiro
...
% (TO-DO: atualizar diagrama pra inserir o módulo EasyELC) - EasyELC se relaciona com ExecutionProfile, Persister e Metrics
