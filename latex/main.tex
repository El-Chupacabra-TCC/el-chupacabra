...
\renewcommand*\lstlistlistingname{\fontsize{16pt}{\baselineskip}\selectfont \textbf{LISTA DE CÓDIGOS}}
...
\chapter{Trabalhos Relacionados}
	...
	\begin{table}[H]
	\centering
	\caption[Strings de busca utilizadas na ferramenta Connected Papers]{Strings utilizadas na ferramenta Connected Papers para encontrar trabalhos relacionados.}
		\begin{tabular}{||c||} 
	...
	\begin{table}[H]
		\centering
		\caption[Total de trabalhos encontrados]{Total de trabalhos encontrados utilizando as ferramentas Elicit e Connected Papers.}
...
\begin{lstlisting}[label={lst:elc_firstnprimes_task}, caption={Exemplo de classe encapsulando um algoritmo de cálculo de números primos.}, language=TypeScript, breaklines=true]
...
\end{minipage}
	...
	\begin{table}[!h]
		\centering
		\caption[Resultados do teste de cálculo de números primos]{Amostra formatada de tempo gasto em cálculos da lista de números no site Calculadora dos Primeiros n Números Primos (do inglês, \emph{First n Primes Calculator}) utilizando o \acr{ELC}.}
		\begin{tabular}{lcc}
			\hline
	...
	\begin{figure}[!ht]
		...
		\caption[Diagrama de Classes]{Diagrama de classes do \acr{ELC}.}
	...
	\begin{figure}[!ht]
		...
		\caption[Diagrama de Módulos]{Diagrama representando os relacionamentos entre os módulos do \acr{ELC}.}
...
\end{minipage}
	...
	\begin{figure}[!ht]
		...
		\caption[Respostas obtidas na pergunta 1 do formulário de avaliação]{Gráfico de barras ilustrando a distribuição das respostas obtidas na pergunta 1 do \acr{SUS}.}
	...
	\begin{figure}[!ht]
		...
		\caption[Respostas obtidas na pergunta 2 do formulário de avaliação]{Gráfico de barras ilustrando a distribuição das respostas obtidas na pergunta 2 do \acr{SUS}.}
	...
	\begin{figure}[!ht]
		...
		\caption[Respostas obtidas na pergunta 3 do formulário de avaliação]{Gráfico de barras ilustrando a distribuição das respostas obtidas na pergunta 3 do \acr{SUS}.}
	...
	\begin{figure}[!ht]
		...
		\caption[Respostas obtidas na pergunta 4 do formulário de avaliação]{Gráfico de barras ilustrando a distribuição das respostas obtidas na pergunta 4 do \acr{SUS}.}
	...
	\begin{figure}[!ht]
		...
		\caption[Respostas obtidas na pergunta 5 do formulário de avaliação]{Gráfico de barras ilustrando a distribuição das respostas obtidas na pergunta 5 do \acr{SUS}.}
	...
	\begin{figure}[!ht]
		...
		\caption[Respostas obtidas na pergunta 6 do formulário de avaliação]{Gráfico de barras ilustrando a distribuição das respostas obtidas na pergunta 6 do \acr{SUS}.}
	...
	\begin{figure}[!ht]
		...
		\caption[Respostas obtidas na pergunta 7 do formulário de avaliação]{Gráfico de barras ilustrando a distribuição das respostas obtidas na pergunta 7 do \acr{SUS}.}
	...
	\begin{figure}[!ht]
		...
		\caption[Respostas obtidas na pergunta 8 do formulário de avaliação]{Gráfico de barras ilustrando a distribuição das respostas obtidas na pergunta 8 do \acr{SUS}.}
	...
	\begin{figure}[!ht]
		...
		\caption[Respostas obtidas na pergunta 9 do formulário de avaliação]{Gráfico de barras ilustrando a distribuição das respostas obtidas na pergunta 9 do \acr{SUS}.}
	...
	\begin{figure}[!ht]
		...
		\caption[Respostas obtidas na pergunta 10 do formulário de avaliação]{Gráfico de barras ilustrando a distribuição das respostas obtidas na pergunta 10 do \acr{SUS}.}
...
\chapter{Conclusão}
	...
	Como dito anteriormente, é possível utilizar o \emph{SheetsonPersister} (ver Subseção \ref{subsection:modulo-persister}), o qual envia os resultados para planilhas do Google via \acr{API}, mas podem ser utilizados diversos tipos de bases de dados, como bancos de dados Postgresql e MongoDB.
