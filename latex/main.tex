...
Aqui deve ser feito um exemplo e explicado sobre os dois exemplos

\section{Primeiro exemplo: Projeto X}

Projeto mais complexo, no qual utilizamos o el-chupacabra de forma mais customizada, inclusive usando o Composite nas tasks.

\section{Segundo exemplo: Projeto Y}

Exemplo mais simples, customizando o menos possível, e com um uso mais simplificado. A ideia é fazer um projeto muito simples. 
Usar as funções de begin e end pra coletar com base no código que já existe.
