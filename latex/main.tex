...
Inicialmente, a ferramenta se estrutura em quatro módulos principais: Módulo de Perfil de Execução (ExecutionProfile), o módulo de Métricas (Metrics), o módulo de Persistência (Persister) e o módulo de Tarefas (Tasks). Cada um deles possui sua responsabilidade, como consta no diagrama a seguir (substituir o diagrama).
