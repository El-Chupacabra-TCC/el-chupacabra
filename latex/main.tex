...
\ddedicatory{
	\raggedleft \normalsize Dedico esse trabalho aos futuros pesquisadores, cuja as descobertas e avanços sejam impulsionados por esse trabalho. Que esse framework que nós desenvolvemos possa servir de apoio para que possam avaliar o desempenho de suas próximas pesquisas.
	Também dedico esse trabalho aos meus professores, cuja orientação nos proporcionaram conhecimentos para realização desse projeto. Seus ensinamentos foram fundamentais para nos capacitar a desenvolver esse trabalho.
}
...
\dacknowledgment{
	...
	Por fim, não posso deixar de agradecer aos meus familiares, cujo apoio, encorajamento e compreensão me motivaram a superar desafios.
}
