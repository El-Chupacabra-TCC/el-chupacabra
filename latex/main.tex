...
\end{minipage}
	...
	\begin{figure}[!ht]
		...
		\caption{Gráfico de barras ilustrando a distribuição das respostas obtidas na pergunta 1 do \acr{SUS}.}
	...
	\begin{figure}[!ht]
		...
		\caption{Gráfico de barras ilustrando a distribuição das respostas obtidas na pergunta 2 do \acr{SUS}.}
	...
	\begin{figure}[!ht]
		...
		\caption{Gráfico de barras ilustrando a distribuição das respostas obtidas na pergunta 3 do \acr{SUS}.}
	...
	\begin{figure}[!ht]
		...
		\caption{Gráfico de barras ilustrando a distribuição das respostas obtidas na pergunta 4 do \acr{SUS}.}
	...
	\begin{figure}[!ht]
		...
		\caption{Gráfico de barras ilustrando a distribuição das respostas obtidas na pergunta 5 do \acr{SUS}.}
	...
	\begin{figure}[!ht]
		...
		\caption{Gráfico de barras ilustrando a distribuição das respostas obtidas na pergunta 6 do \acr{SUS}.}
	...
	\begin{figure}[!ht]
		...
		\caption{Gráfico de barras ilustrando a distribuição das respostas obtidas na pergunta 7 do \acr{SUS}.}
	...
	\begin{figure}[!ht]
		...
		\caption{Gráfico de barras ilustrando a distribuição das respostas obtidas na pergunta 8 do \acr{SUS}.}
	...
	\begin{figure}[!ht]
		...
		\caption{Gráfico de barras ilustrando a distribuição das respostas obtidas na pergunta 9 do \acr{SUS}.}
	...
	\begin{figure}[!ht]
		...
		\caption{Gráfico de barras ilustrando a distribuição das respostas obtidas na pergunta 10 do \acr{SUS}.}
