...
\chapter{Fundamentação teórica}
	\label{cap:fundamentacao_teorica}
		...
		O \acr{OCP} pode ser definido como um artefato de software deve ser aberto para extensão, mas fechado para modificação. \citep{Meyer1997ObjectOrientedSoftwareConstruction}
		...
		Ademais, definimos cada módulos do \acr{ELC} como os pontos de extensão.
...
\end{minipage}
	...
	Por exemplo, são definidas as árvores de herança e principais métodos que precisam ser implementados pelo usuário.
