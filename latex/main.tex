...
\label{cap:metodologiatrabsrelacionados}
	...
	Na tabela \ref{tab:strings-connected-papers} estão listadas as strings de busca utilizadas no Connected Papers, de modo que, para cada uma, a ferramenta gerou um grafo com 40 trabalhos relacionados, os quais também podem ser visualizados em uma tabela.
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\textwidth]{figures/fluxo-decisao-leitura.pdf}
	...
	\begin{table}[!ht]
		...
		\begin{tabular}{l c L{1.5cm} R{1.5cm}}
			...
			\midrule 
			Preservação do código fonte & Se a utilização da ferramenta exige que o código fonte seja pouco alterado.\\
			Métricas customizáveis & Se a ferramenta permite a coleta de métricas customizáveis.\\
			Multiplataforma & Se a ferramenta pode ser utilizada em testes multiplataforma.\\
			Geração de dados & Se a ferramenta gera dados estruturados para análise futura.\\
			\bottomrule
		\end{tabular}
