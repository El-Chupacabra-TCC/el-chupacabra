...
\newacro{CSV}{El Chupacabra Framework}
\newacro{JSON}{El Chupacabra Framework}
...
%TODO-Citar o capítulo do Sommerville ou do Prestman que falam de testes de caixa branca.
...
\label{cap:fundamentacao_teorica}
	...
	\section{Desempenho no processamento de \emph{big data}}
	\label{cap:big-data}
	Inserir texto aqui
...
%TO-DO: Alterar o nome da estratégia de Naive approach para outro nome. 
\begin{table}[!h]
    \centering
