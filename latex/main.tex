...
O trabalho está dividido em cinco capítulos. O capítulo \ref{cap:intro} corresponde à introdução.
O capítulo \ref{cap:fundamentacao_teorica} corresponde à fundamentação teórica do projeto. O capítulo \ref{cap: metodologia_e_trabs_relacionados} corresponde à metodologia utilizada na pesquisa dos trabalhos relacionados e contém também os principais trabalhos relacionados encontrados.
...
\label{cap:metodologia_e_trabs_relacionados}
